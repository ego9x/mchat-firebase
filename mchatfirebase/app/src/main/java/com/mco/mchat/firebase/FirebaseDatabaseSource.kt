...
class FirebaseReferenceConnectedObserver: KoinComponent {
    ...
    fun start(userID: String) {
        ...
        this.dbRef = dbInstance.getReference(".info/connected").apply { addValueEventListener(valueEventListener!!) }
    }
